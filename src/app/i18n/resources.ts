  ...
  en: {
    translation: {
      ...
      errors: {
        ...
        d1DailyQuotaExceeded: 'Cloudflare D1 has reached its daily read or write limit.',
  ...
  fr: {
    translation: {
      ...
      errors: {
        ...
        d1DailyQuotaExceeded: 'Cloudflare D1 a atteint sa limite quotidienne de lectures ou dՎcritures.',
