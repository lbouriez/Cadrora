...
export const publicationResources = {
  en: { publication: {
    ...
    error: 'Gallery availability could not be updated. Please try again.', indexing: 'Preparing photo search',
  ...
  fr: { publication: {
    ...
    error: 'La disponibilité de la galerie n’a pas pu être modifiée. Réessayez.', indexing: 'Préparation de la recherche de photos',
