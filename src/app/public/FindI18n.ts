...
export const findResources = {
  en: { faceFind: {
    ...
    privacy: 'Choose a clear photo of your face. It stays on your device. To search this gallery, we send a face pattern made from it, not the photo itself.',
  ...
  fr: { faceFind: {
    ...
    privacy: 'Choisissez une photo nette de votre visage. Elle reste sur votre appareil. Pour chercher dans cette galerie, nous envoyons une empreinte créée à partir du visage, pas la photo elle-même.',
