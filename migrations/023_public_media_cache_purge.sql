CREATE TABLE maintenance_jobs_v7 (
  id TEXT PRIMARY KEY,
  kind TEXT NOT NULL CHECK (kind IN ('delete_face_vector', 'delete_photo_media', 'delete_gallery', 'delete_gallery_originals', 'delete_replaced_media', 'purge_event_faces', 'purge_expired_faces', 'reconcile_usage', 'purge_gallery_cache')),
...
INSERT INTO maintenance_jobs_v7
...
ALTER TABLE maintenance_jobs_v7 RENAME TO maintenance_jobs;
