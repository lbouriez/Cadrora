-- Add a durable, retryable gallery-scoped job for owner-requested original cleanup.
CREATE TABLE maintenance_jobs_v5 (
  id TEXT PRIMARY KEY,
  kind TEXT NOT NULL CHECK (kind IN ('delete_face_vector', 'delete_photo_media', 'delete_gallery', 'delete_gallery_originals', 'purge_event_faces', 'purge_expired_faces', 'reconcile_usage')),
...
INSERT INTO maintenance_jobs_v5
...
ALTER TABLE maintenance_jobs_v5 RENAME TO maintenance_jobs;
