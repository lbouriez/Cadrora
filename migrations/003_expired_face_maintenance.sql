CREATE TABLE maintenance_jobs_v2 (
  id TEXT PRIMARY KEY,
  kind TEXT NOT NULL CHECK (kind IN ('delete_photo_media', 'purge_event_faces', 'purge_expired_faces', 'reconcile_usage')),
...
INSERT INTO maintenance_jobs_v2 (
...
ALTER TABLE maintenance_jobs_v2 RENAME TO maintenance_jobs;
