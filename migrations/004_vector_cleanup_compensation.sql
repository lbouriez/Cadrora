CREATE TABLE maintenance_jobs_v3 (
  id TEXT PRIMARY KEY,
  kind TEXT NOT NULL CHECK (kind IN ('delete_face_vector', 'delete_photo_media', 'purge_event_faces', 'purge_expired_faces', 'reconcile_usage')),
...
INSERT INTO maintenance_jobs_v3 (
...
ALTER TABLE maintenance_jobs_v3 RENAME TO maintenance_jobs;
